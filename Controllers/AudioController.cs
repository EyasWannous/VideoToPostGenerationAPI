...
//        result.Audio = _mapper.Map<ResponseAudio>(audio);
...
//            {
//                Audio = _mapper.Map<ResponseAudio>(audio),
//                Link = audioLink,
//                IsSuccess = true,
...
//        //    tasks.Add(_unitOfWork.Videos.DeleteAsync(audio.Video));
//        //}

//        //await Task.WhenAll(tasks);

//        //if (audio.Posts.Count > 0)
//        //{
//        //    foreach (var post in audio.Posts)
//        //        tasks.Add(_unitOfWork.Posts.DeleteAsync(post));
//        //}
